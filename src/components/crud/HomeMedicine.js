    ...
    <div>
      ...
      <div>
        ...
        {notFound ? (
          ...
          searchResults.map((item) => (
            <div key={item.id}>
              <h3 className="name1">{item.name}</h3>
              <p className="company1">Company: {item.company}</p>
              <p className="price1">Price: {item.price}</p>
              <p className="quantity1">Quantity: {item.quantity}</p>
              <p className="expiry1">Expiry date: {item.expiry_date}</p>
              <p className="description1">Description: {item.description}</p>
            </div>
          ))
        )}
      </div>
